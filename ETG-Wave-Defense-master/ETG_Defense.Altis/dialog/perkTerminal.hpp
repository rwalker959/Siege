...
class Perks_Terminal
{
	idd = 2000;
	fadeout=0.5;
	fadein=0.5;
	onLoad = "uiNamespace setVariable ['Perks_Terminal', _this select 0];";
	...
	class controlsBackground 
	{
		...
		class txt_head: RscText
		{
			...
			text = "Perk Terminal"; //--- ToDo: Localize;
			x = 0.29375 * safezoneW + safezoneX;
		...
		class txt_upgrade_head: RscText
		{
			idc = -1;
			colorBackground[] = {0.59,0.98,0.13,0.6};
			text = "Available Perks:"; //--- ToDo: Localize;
	...
	class controls
	{
		...
		{
			idc = 2001;
			onLBSelChanged = "[1,'Perks',lbData [2001, lbCurSel 2001],false] call fn_UpgradeTerminal";
			x = 0.304062 * safezoneW + safezoneX;
		...
		{
			idc = -1;
			action = "[lbData [2001, lbCurSel 2001],'Perks'] call fn_useUpgrade;";
			text = "Buy Perk"; //--- ToDo: Localize;
			x = 0.438125 * safezoneW + safezoneX;
